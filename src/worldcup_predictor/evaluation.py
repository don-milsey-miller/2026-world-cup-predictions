...
def evaluate_probabilities(y_true: pd.Series, probabilities, labels: Sequence[str]) -> dict[str, float]:
    ...
    return {
        ...
        "expected_calibration_error": float(expected_calibration_error(y_true, probabilities, labels)),
    }
